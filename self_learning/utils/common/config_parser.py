...
class AbsPoseConfig:
    def __init__(self):
        ...
        # Model training loss
        model_group.add_argument('--selflearn_weight', '-slw', metavar='%f', type=float, default=1,
                                 help='the final value of the self learning parameter')
        model_group.add_argument('--selflearn_weightstart', '-slws', metavar='%f', type=float, default=0,
                                 help='the start value of the self learning parameter')
        model_group.add_argument('--selflearn_epochs', '-sle', metavar='%f', type=float, default=200,
                                 help='epochs to reach the final value of the self learning parameter')
