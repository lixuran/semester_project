...
def main():
    ...
    im_path = 'C:\\Users\\mrlix\\Desktop\\ethsecondyear\\project\\Semester-Project-main\\generate synthetic images\\robocup_thicker.jpeg'
    ...
    if(frontal==True): # todo: what does this viariable represent, does it have to do with the dual solution of a img view?
        ...
        x=-np.pi/2-np.pi/6
        _,ch,row, col = img.shape
        zoom=1900 # what is this is it the focal length?
